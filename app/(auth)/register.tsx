...
const FASHION_IMAGE = 'https://images.unsplash.com/photo-1509631179647-0177331693ae?q=80&w=1888&auto=format&fit=crop';
                    ...
                    >
                        ...
                        >
                            ...
                            <Text style={styles.footerText}>
                                Already a member? <Text style={styles.linkText} onPress={() => router.push('/login')}>Sign In</Text>
                            </Text>
                        </Animated.View>
                    </KeyboardAvoidingView>
                </LinearGradient>
...
const GlassInput = ({ icon, placeholder, value, onFocus, onBlur, secureTextEntry }: any) => (
