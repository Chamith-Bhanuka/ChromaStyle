    ...
    return (
        ...
        >
            <Tabs.Screen
                name="home"
                options={{
                    tabBarIcon: ({ focused }) => <TabIcon focused={focused} Icon={Home} colors={colors} />,
                }}
            />
            ...
            <Tabs.Screen
                name="news"
                options={{
                    tabBarIcon: ({ focused }) => <TabIcon focused={focused} Icon={Shirt} colors={colors} />,
                }}
            />
            ...
            <Tabs.Screen
                name="tasks"
                options={{
                    tabBarIcon: ({ focused }) => <TabIcon focused={focused} Icon={Calendar} colors={colors} />,
                }}
            />
            ...
            <Tabs.Screen
                name="profile"
                options={{
                    tabBarIcon: ({ focused }) => <TabIcon focused={focused} Icon={User} colors={colors} />,
                }}
            />
        </Tabs>
    );
